  ...
  public void testCreateParquetTypeFromSchemaTypeDescriptor() {
    ...
    List<String> expectedFields =
        Arrays.asList(
            ...
            "repeated binary array_of_strings_field (STRING)",
            "repeated double array_of_double_field",
            "optional group structure_field_with_primitive {optional int32 inner_integer;}",
            "optional group structure_field_with_array {repeated double inner_array;}",
