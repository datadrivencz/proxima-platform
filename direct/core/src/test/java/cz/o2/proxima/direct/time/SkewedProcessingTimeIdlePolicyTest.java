...
import static cz.o2.proxima.direct.time.WatermarkConfiguration.cfgKey;
...
public class SkewedProcessingTimeIdlePolicyTest {
  ...
  private SkewedProcessingTimeIdlePolicy.TimestampSupplier timestampSupplier;

  @Before
  public void setup() {
    now = Instant.now().toEpochMilli();
    timestampSupplier = mock(SkewedProcessingTimeIdlePolicy.TimestampSupplier.class);
  ...
  public void testFactoryConfig() {
    Map<String, Object> cfg =
        new HashMap<String, Object>() {
          {
            put(cfgKey(SkewedProcessingTimeIdlePolicy.TIMESTAMP_SKEW), TIMESTAMP_SKEW);
          }
        };
  ...
  public void testFactoryLegacyAndNewConfig() {
    ...
    Map<String, Object> cfg =
        new HashMap<String, Object>() {
          {
            put(cfgKey(SkewedProcessingTimeIdlePolicy.TIMESTAMP_SKEW), newTimestampSkew);
